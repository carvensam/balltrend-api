...
TEAM_SHORT_ZH = {
    ...
    'Kumamoto': '熊本深紅',
    'Yamaga': '松本山雅',
    # === The Odds API 實際返回名（補漏）===
    'ADO Den Haag': 'ADO海牙',
    'Aldosivi Mar del Plata': '阿度斯維',
    'Atlético Huracán': '颶風隊',
    'Atlético Tucuman': '圖庫曼競技',
    'Belgrano de Cordoba': '貝格拉諾',
    'Bolton Wanderers': '保頓',
    'Bragantino-SP': '巴拉干天奴',
    'Brighton and Hove Albion': '白禮頓',
    'CA Tigre BA': '堤格雷',
    'Cercle Brugge KSV': '色格拉布魯日',
    'Columbus Crew SC': '哥倫布機員',
    'Deportes Concepción': '康塞普森體育',
    'Deportes Limache': '利馬切體育',
    'Estudiantes de Río Cuarto': '里奧誇爾托學生隊',
    'FC Energie Cottbus': '科特布斯',
    'FC Juárez': '祖亞雷斯',
    'FC Zwolle': '施奧達',
    'Fagiano Okayama': '岡山綠雉',
    'Gimnasia La Plata': '甘拿斯亞',
    'Hiroshima Sanfrecce FC': '廣島三箭',
    'Instituto de Córdoba': '科爾多瓦學院',
    'JEF United Chiba': '千葉市原',
    'Leuven': '奧特海維利',
    'Lincoln City': '林肯城',
    'RAAL La Louvière': '拉盧維耶爾',
    'Sangju Sangmu FC': '尚州尚武',
    'SC Paderborn': '柏達邦',
    'SC Telstar': '泰斯達',
    'SV Zulte-Waregem': '華雷根',
    'Universidad Católica (CHI)': '智利天主教大學',
    'VfL Osnabrück': '奧斯納貝克',
    'Wrexham AFC': '域斯咸',
}
